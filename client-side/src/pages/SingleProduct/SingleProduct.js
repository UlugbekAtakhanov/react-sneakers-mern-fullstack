...
//     const {attributes, image, name, price, company, quantity} = singleProduct
...
//     const [singleProdAttr, setSingleProdAttr] = useState("")
...
//                         </div>
//                         {singleProdAttr && singleProdAttr.map(item => {
//                             // console.log(item);
//                             return (
//                                 <div>
//                                     {item.attrValue.length > 0 && item.attrValue.map(attr => {
//                                         console.log(attr);
//                                         return (
//                                             <div>
//                                                 <span>{attr.attrId.name}:</span>
