    ...
    return (
        <div className="card">
            ...
            <div className="flex items-center gap-4">
                ...
                <Link to = {`/products/${item._id}`} className='hover:bg-red-500'>
                    <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-shopping-cart-plus" width="24" height="24" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#009988" fill="none" strokeLinecap="round" strokeLinejoin="round">
